...
<head>
  			...
  			<div class="col-md-12 col-sm-12 col-xs-12">
  				<div class="cards-panel">
  					<div class="cards-body ">
  						<div id="head-content">
  							<div class="alert alert-success text-center"><h3><strong>Selamat Datang di Aplikasi Pengumpulan Revisi Tugas 2</strong></h3></div>
  						...
  						<div id="content-ketentuan">
  							...
  							<ol>
  								...
  								<li>Jawaban dapat diupload dua kali atau lebih namun yang digunakan adalah jawaban yang terakhir diupload</li>
  								<li>Batas Pengumpulan Jawaban adalah <strong>hari Selasa, 17 Mei 2016 jam 23.59 WIB</strong></li>
  							</ol>
  							<hr>
  						</div>
  							...
  							if($kirim){
	  							...
	  							<form class="form-horizontal" enctype="multipart/form-data" method="POST" id="form-tugas" action="">
	  								...
	  								<div class="form-group">
	  									...
	  									<div class="col-sm-4">
	  										<input type="file" name="nomor_1" id="nomor_1">
	  									</div>
	  								</div>
	  								<div class="form-group">
	  									<label class="col-sm-4 control-label">Jawaban nomor 2</label>
	  									<div class="col-sm-4">
	  										<input type="file" name="nomor_2" id="nomor_2">
	  									</div>
	  								</div>
	  								<div class="form-group">
  ...
  <?php
	...
	if (isset($_POST['nim'])){
	    ...
	    if (isset($_FILES['nomor_1'])) {
		    ...
		    if ($ext1 == "ms11" || $ext1 == "MS11") {
		    	if (!empty($_FILES['nomor_1']['tmp_name'])) {
			    	...
			    	header('location:?status=danger&message=Gagal Mengupload Jawaban Tugas 3');
			    }
		    } else {
		...
		header('location:?status=success&message=Berhasil Mengirim Jawaban Tugas 3. Terima Kasih');
	}
