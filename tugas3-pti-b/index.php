  			...
  			<div class="col-md-12 col-sm-12 col-xs-12">
  				<div class="cards-panel">
  					<div class="cards-body ">
  						<div id="head-content">
  							<div class="alert alert-success text-center"><h3><strong>Selamat Datang di Aplikasi Pengumpulan Tugas 3</strong></h3></div>
  						...
  						<div id="content-ketentuan">
  							...
  							<ol>
  								...
  								<li>Batas Pengumpulan Jawaban adalah <strong>hari Senin, 16 Mei 2016 jam 23.59 WIB</strong></li>
  							</ol>
  							<hr>
  						</div>
